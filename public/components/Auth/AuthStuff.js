        ...
        <View style={styles.container}>
            ...
            <View style={styles.container2}>
                ...
                <View style={styles.cont2Child2}>
                    ...
                    <TextInput style={indiStyles.inp1} placeholder='Enter Email' value={email} onChangeText={text => setEmail(text)}></TextInput>
                    <TextInput style={indiStyles.inp1} placeholder='Enter Password' value={pass} onChangeText={text => setPass(text)}></TextInput>
                    <TouchableOpacity>
